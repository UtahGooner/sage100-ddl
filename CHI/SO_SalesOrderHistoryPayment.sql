CREATE TABLE SO_SalesOrderHistoryPayment
(
...
CREATE INDEX KEY0 on SO_SalesOrderHistoryPayment (SalesOrderNo, PaymentSeqNo);
CREATE INDEX KEY1 on SO_SalesOrderHistoryPayment (SalesOrderNo, PaymentType, PaymentSeqNo);
CREATE INDEX KEY2 on SO_SalesOrderHistoryPayment (ExpirationDateYear, ExpirationDateMonth, SalesOrderNo, PaymentSeqNo);
