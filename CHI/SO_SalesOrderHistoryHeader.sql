CREATE TABLE SO_SalesOrderHistoryHeader
(
    ...
    TaxSubjToDiscPrcntTotSubjTo  decimal(8, 3)  DEFAULT NULL,
...
CREATE INDEX KEY0 on SO_SalesOrderHistoryHeader (SalesOrderNo);
CREATE INDEX KEY1 on SO_SalesOrderHistoryHeader (ARDivisionNo, CustomerNo, SalesOrderNo);
CREATE INDEX KEY2 on SO_SalesOrderHistoryHeader (BillToName, SalesOrderNo);
CREATE INDEX KEY3 on SO_SalesOrderHistoryHeader (CustomerPONo, SalesOrderNo);
CREATE INDEX KEY4 on SO_SalesOrderHistoryHeader (ARDivisionNo, CustomerNo, CustomerPONo, SalesOrderNo);
CREATE INDEX KEY5 on SO_SalesOrderHistoryHeader (OrderDate, SalesOrderNo);
CREATE INDEX KEY6 on SO_SalesOrderHistoryHeader (OrderStatus, CancelReasonCode, SalesOrderNo);
