...
(
    ...
    SOHistoryDetlSeqNo        varchar(14)    DEFAULT NULL,
    ...
    RepeatingQtyShippedToDate decimal(15, 6) DEFAULT NULL,
    ...
    LotSerialFullyDistributed varchar(1)     DEFAULT NULL,
...
CREATE INDEX KEY0 on SO_SalesOrderDetail (SalesOrderNo, LineKey);
CREATE INDEX KEY1 on SO_SalesOrderDetail (SalesOrderNo, LineSeqNo, LineKey);
CREATE INDEX KEY2 on SO_SalesOrderDetail (ExtendedDescriptionKey, SalesOrderNo, LineKey);
CREATE INDEX KEY3 on SO_SalesOrderDetail (ItemType, ItemCode, SalesOrderNo, LineKey);
CREATE INDEX KEY4 on SO_SalesOrderDetail (ItemCode, WarehouseCode, SalesOrderNo, LineKey);
CREATE INDEX KEY5 on SO_SalesOrderDetail (APDivisionNo, VendorNo, SalesOrderNo, LineKey);
