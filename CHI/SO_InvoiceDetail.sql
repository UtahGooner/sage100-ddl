...
(
    ...
    ExtendedNegQtyAdj         decimal(11, 2) DEFAULT NULL,
    ...
    PRIMARY KEY (`InvoiceNo`, `LineKey`)
);
CREATE INDEX KEY0 on SO_InvoiceDetail (InvoiceNo, LineKey);
CREATE INDEX KEY1 on SO_InvoiceDetail (InvoiceNo, LineSeqNo, LineKey);
CREATE INDEX KEY2 on SO_InvoiceDetail (ExtendedDescriptionKey, InvoiceNo, LineKey);
CREATE INDEX KEY3 on SO_InvoiceDetail (ItemCode, InvoiceNo, LineKey);
CREATE INDEX KEY4 on SO_InvoiceDetail (ItemCode, WarehouseCode, InvoiceNo, LineKey);
CREATE INDEX KEY5 on SO_InvoiceDetail (APDivisionNo, VendorNo, InvoiceNo, LineKey);
